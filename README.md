...
[![Changelog](https://img.shields.io/badge/changelog-2.2.0-brightgreen.svg)](CHANGELOG.md)
[![Javadoc](https://img.shields.io/badge/javadoc-yes-brightgreen.svg)](https://javadoc.jitpack.io/com/github/diffplug/spotless-changelog/spotless-changelog-agg/release~2.2.0/javadoc/)
...
### Plugin DSL ([javadoc](https://javadoc.io/static/com.diffplug.spotless-changelog/spotless-changelog-plugin-gradle/2.2.0/com/diffplug/spotless/changelog/gradle/ChangelogExtension.html))
...
### Tasks ([code](https://github.com/diffplug/spotless-changelog/blob/release/2.2.0/spotless-changelog-plugin-gradle/src/main/java/com/diffplug/spotless/changelog/gradle/ChangelogPlugin.java))
