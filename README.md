...
```gradle
plugins {
  id 'com.diffplug.spotless-changelog' version '3.1.0'
}
...
### Plugin DSL ([javadoc](https://javadoc.io/static/com.diffplug.spotless-changelog/spotless-changelog-plugin-gradle/3.1.0/com/diffplug/spotless/changelog/gradle/ChangelogExtension.html))
...
### Tasks ([code](https://github.com/diffplug/spotless-changelog/blob/release/3.1.0/spotless-changelog-plugin-gradle/src/main/java/com/diffplug/spotless/changelog/gradle/ChangelogPlugin.java))
